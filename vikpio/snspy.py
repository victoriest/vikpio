...
if __name__ == '__main__':
    ...
    #doctest.testmod()
    APP_KEY = '833312460'
    APP_SECRET = '0ab768f8fcb3b0d4517e82e3d4030274'
    access_token = '???'
    expires = 1393739173.5
    c = APIClient(QQMixin, APP_KEY, APP_SECRET, 'https://api.weibo.com/oauth2/default.html', access_token, expires)
    openid = c.get_openid(access_token)
    print openid
